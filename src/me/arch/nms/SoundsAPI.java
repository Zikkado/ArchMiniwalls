...
public enum SoundsAPI {
  ...
  SoundsAPI(String tentativa1, String tentativa2) {
    this.tentativa1 = tentativa1;
    this.tentativa2 = tentativa2;
  }
  
  private final String tentativa1;
  
  private final String tentativa2;
  
  public String getTentativa1() {
    return this.tentativa1;
  }
  
  public String getTentativa2() {
    return this.tentativa2;
  }
  ...
  public Sound PlaySound() {
    try {
      return Sound.valueOf(this.tentativa2);
    } catch (IllegalArgumentException e) {
      try {
        return Sound.valueOf(this.tentativa1);
